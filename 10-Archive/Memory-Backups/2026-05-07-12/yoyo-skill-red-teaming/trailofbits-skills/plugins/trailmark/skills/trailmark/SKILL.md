---
name: trailmark
description: Builds and queries multi-language source code graphs for security analysis.
  Includes pre-analysis passes for blast radius, taint propagation, privilege boundaries,
  and entry point enumeration. Use when analyzing call paths, mapping attack surface,
  finding complexity hotspots, enumerating entry points, tracing taint propagation,
  measuring blast radius, or building a code graph for audit prioritization. Supports
  16 languages including Solidity, Cairo, Circom, Rust, Go, Python, C/C++, TypeScript.
domain: red-teaming
tags:
- trailmark
- class-level
...
- **Full reference:** `references/trailmark-structural/SKILL.md`
- **Execution scripts:** `scripts/trailmark-structural/`
...
- **Full reference:** `references/trailmark-summary/SKILL.md`
- **Execution scripts:** `scripts/trailmark-summary/`