...
Any vault note in `06-Security/` tagged with `#needs-content` triggers this pipeline. Desmond picks it up, writes a script, and puts it in `04-Entertainment/Scripts/`.
