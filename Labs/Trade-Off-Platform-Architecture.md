...
- `Labs/tech-payment-router/` — Foundry project with DiscountCalculator, BurnSplitter, TechPaymentRouter
- `Green-Room/trade-off-concept-brainstorm.md` — Original brainstorm with dynamic discount resolution
- `Green-Room/AgentFi-Layer7-DeepDive.md` — Layer 7 economics architecture
