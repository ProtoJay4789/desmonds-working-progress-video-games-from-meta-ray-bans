...
- `09-Green Room/designs/trade-roast-v2.md` — Trade Roast (sister product)
- `09-Green Room/designs/echo-brain-architecture.md` — Echo Brain (memory layer)
- `09-Green Room/designs/aeg-agent-economy-gaming.md` — AEG (game mechanics)
- `09-Green Room/designs/voice-cloned-learning-companions.md` — Voice personalities
- `02-Labs/AgentEscrow/governance/` — OWASP governance (46 rules)
- `09-Green Room/alliance-application-draft.md` — Alliance application
