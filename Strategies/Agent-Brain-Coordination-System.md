...
- DMOB Analysis: `Green-Room/dmob-self-evolution-aae-analysis.md`
- YoYo's GEPA Assessment: `Green-Room/handoff-hermes-self-evolution-evaluation.md`
- AAE Watchdog Layer: `Strategies/AAE-Watchdog-Layer.md`
- AgentEscrow Vision: `Strategies/AgentEscrow-Product-Vision.md`
