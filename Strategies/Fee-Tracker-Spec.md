...
> **Frontend Contract**: Any new metric added to the LP Cron must have a corresponding UI card in `DeFi-Milestone-Tracker.html` and a preset mapping in this spec. See `Labs/LP-Tracker-Config.md` §Frontend Contract.
...
- Spec: `Strategies/Fee-Tracker-Spec.md` (this file)
- AAE Signal Spec: `Strategies/AAE-Signal-Spec.md`
- LP Monitor Rules: `Strategies/LP-Monitor-Rules.md`
