...
1. `Strategies/research/deeptutor-agentescrow-analysis.md` — DeepTutor architecture mapping
2. `Strategies/research/agentescrow-monetization.md` — Full monetization model
3. `Strategies/research/agentescrow-extensions-tiers.md` — Extension/tier pricing
