...
- [x] Create smart routing rules (`HQ/smart-routing-rules.md`)
...
|-------------|----------|--------------|
| DeFi/LP/portfolio | YoYo | Strategies/ |
| Smart contracts/security | DMOB | Projects/ |
| Content/social/submissions | Desmond | Content/ |
| Coordination/approval | Gentech | Mess-Hall/ |
| Emergency/blocked | Jordan | HQ/ |
