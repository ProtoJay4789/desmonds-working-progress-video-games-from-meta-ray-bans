...
| Skill | Supports | Role |
|-------|----------|------|
| Raise Shield | Vanguard | Defensive — block |
| Rend | Rage | DoT — physical bleed |
| Mace Strike | Rage | Primary attack — physical |
| Rolling Slam | Fist of War, Magnified Area | Burst — AoE slam |
| Bone Shatter | *(none)* | Burst — stun/physical |
| Infernal Cry | Tireless, Armor Explosion | Buff — warcry |

### Wyvern Set (Secondary)
| Skill | Supports | Role |
|-------|----------|------|
| Thunderstorm | Magnified Area | AoE — lightning |
| The Vower | Thrill of the Kill, Empowered Sparks | Sustained — spark |
| Savage Fury | Prolonged Duration, Efficacy | Buff — duration |
| Rolling Magma | Magnified Area, Multi Shot | AoE — fire |
