...
|--------|----------------|------|
| Mess Hall | Agent discussions, decisions, debates | `Mess-Hall/Chat — {date}.md` |
| Strategies | Research findings, data analysis, BTC repo insights | `Strategies/` |
| Labs | Code commits, technical breakthroughs | `Labs/` |
...
4. **Save drafts** → `Entertainment/x-drafts/{YYYY-MM-DD}/`
...
- Status: Drafted, saved in `Strategies/x-content-drafts.md`
