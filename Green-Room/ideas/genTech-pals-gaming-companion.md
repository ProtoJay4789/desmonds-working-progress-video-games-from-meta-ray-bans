...
- **Build Context:** Vault files (`Gaming/POE-2/Jordan Monk build.md`)
...
5. Integration with existing `Gaming/POE-2/` vault structure
...
- **Vault:** `Gaming/POE-2/` (existing build files)
