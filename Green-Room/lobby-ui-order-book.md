...
**Depends on:** [[Green-Room/lobby-ui-product-vision.md]]
...
→ See [[Green-Room/lobby-ui-product-vision.md]] (base Lobby UI design)
→ See [[Green-Room/gentech-agents-open-source.md]] (open-source framework)
