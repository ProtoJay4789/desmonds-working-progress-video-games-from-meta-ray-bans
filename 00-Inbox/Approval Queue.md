...
- [x] **Termux SSH key** — Dmob needs your pubkey for mobile VPS access
...
**How to clear items:** Just tell any agent in Telegram, or flip the checkbox here.
**Agents:** Only add stuff that's hard to reverse. Everything else — just do it.
