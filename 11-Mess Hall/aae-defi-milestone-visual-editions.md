...
- **Path:** `Strategies/Defi-Monitor/defi-milestone-tracker.html`
...
- **Path:** `Strategies/Defi-Monitor/yield-farm-tracker.html`
...
→ See [[HQ/AAE-DeFi-Milestone-Spec.md]] (Full spec)
→ See [[Strategies/Defi-Monitor/]] (Templates)
