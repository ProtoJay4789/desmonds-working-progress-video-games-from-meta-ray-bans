...
**Deliverables:**
- Full review: `Labs/Approvals/DMOB-Dynamic-Burn-Rate-Feasibility-Approved.md`
- Summary in HQ: `HQ/Approvals/2026-05-02-dynamic-burn-rate-sc-feasibility-approval.md`
...
**Deliverables:**
- Full review: `Labs/Approvals/DMOB-Gas-Reserve-AutoRebalance-Approved.md`
- Summary in HQ: `HQ/Approvals/2026-05-02-gas-reserve-auto-rebalance-approval.md`
- Handoff board updated (Mess Hall)
...
- Both approvals are visible in `HQ/Approvals/` — your inbox for sign-offs
- Detailed technical reviews live in `Labs/Approvals/` (Labs domain)
- Handoff board in `Mess-Hall/handoff-board.md` updated to COMPLETED
