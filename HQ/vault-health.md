...
### Recommendations
1. **Archive aggressively.** Move completed hackathons, old daily digests, and resolved issues to `Archive/`. The `Labs/` folder is 727 notes — likely many are finished or abandoned.
