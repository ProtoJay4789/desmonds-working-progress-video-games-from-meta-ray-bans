# Agent Config Backup — 2026-04-26_114451

## Chat Models

| Agent | Provider | Model |
|-------|----------|-------|
| Gentech (HQ) | ollama-cloud | deepseek-v4-flash |
| YoYo (Strats) | ollama-cloud | deepseek-v4-flash |
| DMOB (Labs) | ollama-cloud | qwen3-coder-next |
| Desmond (Creative) | ollama-cloud | deepseek-v4-flash |
| CLI | ollama-cloud | deepseek-v4-flash |
...
| YoYo (Strats) | opencode-go | kimi-k2.6 |
| DMOB (Labs) | opencode-go | kimi-k2.6 |
| Desmond (Creative) | opencode-go | kimi-k2.6 |
| CLI | opencode-go | kimi-k2.6 |

## Auth Status

gentech: auth.json present
yoyo: auth.json present
dmob: auth.json present
desmond: auth.json present

## Cron Jobs (24 total)

All 24 scheduled, 0 paused, 0 deprecated models.
...
_Backup generated at 2026-04-26_114451 UTC. To restore, copy configs from this file back to each profile's config.yaml._
