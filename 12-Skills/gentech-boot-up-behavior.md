...
2. Read latest session state save in 09-Green Room/ (if exists)
3. Check 01-Agency/Approvals/ for pending Jordan decisions
4. Check 09-Green Room/ for active handoffs
5. Check 11-Mess Hall/ for recent discussions
```
...
### Gentech (HQ)
- Read 09-Green Room/ for all active handoffs
