...
- /root/vaults/gentech/Green-Room/ (active handoffs)
- /root/vaults/gentech/Mess-Hall/ (recent discussions)
- /root/vaults/gentech/Archive/Memory-Backups/ (latest backup)
```
...
- Check `Entertainment/` for active content drafts
...
- Check `Strategies/` for active positions
...
- Check `Labs/Bug-Bounties/` for active hunts
...
2. Read latest backup from `Archive/Memory-Backups/`
